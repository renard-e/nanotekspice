//
// 4081.cpp for nanotekspice in /media/rodrigue/1aa9b3b8-3e24-4ea9-9b0d-d57254b2d1b9/rodrigue.rene/Cours/Semestre_4/C++/cpp_nanotekspice/lib/component
//
// Made by Rodrigue René
// Login   <rodrigue.rene@epitech.eu>
//
// Started on  Sun Feb 12 16:59:00 2017 Rodrigue René
// Last update Sun Mar  5 03:54:05 2017 Rodrigue René
//
...
void	Computer::filler(nts::Processor *piece, int actual, int first, int second, int type) const
{
...
nts::IComponent	*Computer::create4081(const std::string &value) const
{
  nts::Processor *piece = new nts::Processor("4081", value);
  //  std::cout<<"create4081"<<std::endl;
  piece->_name = value;
  piece->_typeProc = "4081";
  //pin1
