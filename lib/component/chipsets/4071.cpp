//
// 4071.cpp for nanotekspice in /media/rodrigue/1aa9b3b8-3e24-4ea9-9b0d-d57254b2d1b9/rodrigue.rene/Cours/Semestre_4/C++/cpp_nanotekspice/lib/component/chipsets
//
// Made by Rodrigue René
// Login   <rodrigue.rene@epitech.eu>
//
// Started on  Wed Mar  1 21:16:28 2017 Rodrigue René
// Last update Sun Mar  5 18:18:54 2017 Rodrigue René
//
...
void	Computer::filler4071(nts::Processor *piece, int actual, int first, int second, int type) const
{
...
nts::IComponent	*Computer::create4071(const std::string &value) const
{
  nts::Processor *piece = new nts::Processor("4071", value);
  //  std::cout<<"create4071"<<std::endl;
  piece->_name = value;
  piece->_typeProc = "4071";
  //pin1
  filler(piece, 1, -1, -1, 0);
  //pin2
  filler(piece, 2, -1, -1, 0);
  //pin3
  filler4071(piece, 3, 1, 2, 2);
  std::get<5>(piece->_listPin[3]).push_back(1);
  std::get<5>(piece->_listPin[3]).push_back(2);
  //pin4
  filler4071(piece, 4, 5, 6, 2);
