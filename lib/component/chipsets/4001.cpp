//
// 4001.cpp for nanotekspice in /media/rodrigue/1aa9b3b8-3e24-4ea9-9b0d-d57254b2d1b9/rodrigue.rene/Cours/Semestre_4/C++/cpp_nanotekspice/lib/component/chipsets
//
// Made by Rodrigue René
// Login   <rodrigue.rene@epitech.eu>
//
// Started on  Wed Mar  1 20:28:00 2017 Rodrigue René
// Last update Sat Mar  4 20:11:51 2017 Rodrigue René
//
...
void	Computer::filler4001(nts::Processor *piece, int actual, int first, int second, int type) const
{
...
nts::IComponent	*Computer::create4001(const std::string &value) const
{
  nts::Processor *piece = new nts::Processor("4001", value);
  piece->_name = value;
  piece->_typeProc = "4001";
  //pin1
